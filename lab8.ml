...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    evt := List.filter (fun {id = x; _} -> x <> i) !evt
...
......................................................................*)
  ...
  let fire_event (evt : 'a event) (arg : 'a) : unit =
    List.iter (fun {id = _ ; action = x} -> x arg) !evt
...
let fake = WEvent.add_listener newswire fakeNewsNetwork ;;
let buzz = WEvent.add_listener newswire buzzFake ;;
...
WEvent.remove_listener newswire fake ;;
WEvent.remove_listener newswire buzz ;;
